...
const menuItems = [
  ...
  { label: "MATH GAME ARENA", icon: Trophy, path: "/math-game-arena", desc: "Tantangan matematika kelas 7, 8, dan 9" },
  ...
  { label: "KUMPULAN RUMUS MATEMATIKA", icon: BookMarked, path: "/kumpulan-rumus", desc: "Kumpulan rumus matematika lengkap" },
  { label: "KONVERSI SATUAN", icon: Calculator, path: "/konversi-satuan", desc: "Konversi berbagai satuan matematika" },
